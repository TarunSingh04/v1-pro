...
export { DashboardPage, MyTasksPage, ScorecardPage, ReportsPage, SustainanilityPage, CertificatesPage, UtilitiesPage, MarketplacePage, LearningPage, NewsPage, ProfileInfoPage };